      ...
      <div class="popup-modal-content rounded-xl">
        ...
        <div class="row">
          <div class="col-md-12 mx-auto">
            <h3 class="text-left mb-4 font-poppins font-semibold md:text-[1.062rem] text-[0.90rem] text-routersTextColor"> Create New Ticket</h3>
            <form >
                <div class="mb-1">
                    <label
                for="small-input"
            ...
            <div class="mb-1">
              ...
              <textarea  v-modal="message" id="message" rows="4" class="text-[14px] w-full h-[5rem] border-[0.063rem] bg-white rounded-[0.625rem] px-3 py-2 border-textFieldBorder" placeholder="Write your thoughts here..."></textarea>
              </div>
              <div
